      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold font-display neon-text">AQ-Immune</h1>
              <p className="text-xs text-slate-500 -mt-0.5">AI Air Intelligence</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="lg:hidden text-slate-400 hover:text-white p-1 rounded-lg hover:bg-white/5 transition-all"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
                ...
                {({ isActive }) => (
                  <>
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all
                      ...
                      <Icon className={`w-4 h-4 ${isActive ? link.color : 'text-slate-400 group-hover:' + link.color}`} />
                    </div>
                    <span className={`flex-1 text-sm font-medium ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-white'}`}>
                      {link.label}
                    </span>
                    {showBadge && (
