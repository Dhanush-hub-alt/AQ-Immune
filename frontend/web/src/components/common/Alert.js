...
export const Alert = ({ type = 'info', title, message, closeable = true, onClose, className, }) => {
    const styles = {
        success: {
    ...
    return (_jsxs("div", { className: `${style.bg} ${style.border} border rounded-lg p-4 flex gap-3 items-start ${className || ''}`, children: [_jsx("div", { className: `${style.icon} flex-shrink-0 mt-0.5`, children: icons[type] }), _jsxs("div", { className: "flex-1", children: [title && _jsx("h3", { className: `font-semibold ${style.title}`, children: title }), _jsx("div", { className: style.message, children: message })] }), closeable && (_jsx("button", { onClick: onClose, className: `${style.button} flex-shrink-0`, children: _jsx("svg", { className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) }) }))] }));
};
